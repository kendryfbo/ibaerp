...
class Product(models.Model):
    ...
    descr1 = models.TextField(max_length=200)
    descr2 = models.TextField(max_length=200, null=True, blank=True)
    detail = models.TextField(max_length=250,null=True, blank=True)
